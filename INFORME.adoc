...
Atravez del desarrollo de esta base de datos pudimos llegar a distintos aprendizajes cada uno, como lo  

fueron las maneras en que se debe organizar un grupo de progrmadores para dividir las tareas, o como 

complementarse para sacar el maximo provecho de las caracterizticas de cada uno.

tambien aprendimos como es la experiencia de la creacion de una base de datos compleja, 

la cual ninguno de los miembros del grupo jamas habia hecho y lograr que esta pueda 
